...
**Timeline:** Compressed — conference is April 16, 2026. Post every 2-3 days.
...
#MCP #AI #EngineeringLeadership #Conference #Prague #Claude
...
The whole thing is stateless. Each request creates a fresh server instance. No database, no sessions.
...
https://github.com/marian-kamenistak/elc-conference-mcp-tickets
...
2. "Any tickets left?" → Live pricing, remaining count
3. "I'll take one." → Direct purchase link
...
Try it: add this URL to your Claude MCP config:
https://mcp.elc-conference.io/mcp

Full details: https://elc-conference.io/

#ELCConference #MCP #AI #TicketInnovation #EngineeringLeadership

---

## Post 4: Last Call (Day 10)
...
Don't wait for the "sold out" post.
...
| Post | Date | Day |
|------|------|-----|
| Post 1: Launch | April 3 (Thu) | Today |
| Post 2: Behind the scenes | April 5 (Sat) or April 7 (Mon) | +2-4 |
| Post 3: Demo video | April 9 (Wed) | +6 |
| Post 4: Last call | April 13 (Sun) or April 14 (Mon) | +10-11 |
...
- **Hashtags:** Max 5-7 per post. Mix broad (#AI) with niche (#MCP).
...
- Track SimpleShop form visits from MCP server referrals
